...
motiffile = "../motifDB/jaspar_clusteredMotifs.pscm"
...
names(M) <- names
saveRDS(M, "../motifDB/motifs_cluster.rds")
...
write.table(res_mESC_high,"../RESULTS_motifcounter/motifcounter_strongESC_clusteredMotifs.txt", quote = F,row.names = F)
...
write.table(res_mESC_low,"../RESULTS_motifcounter/motifcounter_weakESC_clusteredMotifs.txt", quote = F,row.names = F)
...
write.table(res_RARa_high,"../RESULTS_motifcounter/motifcounter_strongRARa_clusteredMotifs.txt", quote = F,row.names = F)
...
write.table(res_RARa_low,"../RESULTS_motifcounter/motifcounter_weakRARa_clusteredMotifs.txt", quote = F,row.names = F)
